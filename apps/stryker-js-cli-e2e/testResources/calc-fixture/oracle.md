...
(`packages/stryker-js-language/src/Schema.schema.ts:115,166`), so the whole registry is active.
...
`coverageAnalysis` defaults to `perTest` (`packages/stryker-js-language/src/Schema.schema.ts:5,139`).
