...
| **SP5** | Every behavior is pinned by a case table — no FastCheck generator and no snapshot call.                                   | `pnpm --filter @systemfsoftware/stryker-ignorer-workflow-make-boundary lint` |
