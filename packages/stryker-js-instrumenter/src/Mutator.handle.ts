...
export const TypeId = Symbol.for('~systemfsoftware/stryker-js-instrumenter/Mutator')
...
export interface MutatorRegistry extends Pipeable {
  readonly [TypeId]: typeof TypeId
  readonly mutators: Readonly<Record<string, Mutator>>
  create(options: CreateMutantOptions): Mutant
  apply(mutant: Mutant, originalTree: Node): Result.Result<Node, MutantNotApplied>
  toApi(mutant: Mutant): Result.Result<ApiMutant, MutantSpanMissing>
}

export const isMutatorRegistry = (value: unknown): value is MutatorRegistry => Predicate.hasProperty(value, TypeId)

export const MutatorRegistry: MutatorRegistry = {
  [TypeId]: TypeId,
