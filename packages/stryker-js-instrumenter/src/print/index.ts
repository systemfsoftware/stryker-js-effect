...
const NODE_TEXT: { readonly [K in Node['type']]: NodeRenderer<K> } = {
  ...
  TSAnyKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSArrayType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSBigIntKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSBooleanKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSConditionalType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSConstructorType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSFunctionType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSImportType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSIndexedAccessType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSInferType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSIntersectionType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSIntrinsicKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSJSDocNonNullableType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSJSDocNullableType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSJSDocUnknownType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSLiteralType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSMappedType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSNamedTupleMember: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSNeverKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSNullKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSNumberKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSObjectKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSOptionalType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSParenthesizedType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSRestType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSStringKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSSymbolKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTemplateLiteralType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSThisType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTupleType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTypeLiteral: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTypeOperator: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTypePredicate: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTypeQuery: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSTypeReference: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSUndefinedKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSUnionType: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSUnknownKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
  TSVoidKeyword: (ctx, n, prec) => printTSTypeToString(ctx, n, prec),
