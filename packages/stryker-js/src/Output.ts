...
import { Heartbeat, HelpRendered, type RunEvent, RunFailed, RunStarted, VerdictReached } from './RunEvents.js'
...
class RunEventStreamPortTag extends Context.Service<RunEventStreamPortTag, RunEventStreamPort>()(
  '@systemfsoftware/stryker-js/Output/RunEventStreamPortTag',
) {}
...
class OutputModeProbeTag extends Context.Service<OutputModeProbeTag, OutputModeProbe>()(
  '@systemfsoftware/stryker-js/Output/OutputModeProbeTag',
) {}
