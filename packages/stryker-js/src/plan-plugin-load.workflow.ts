...
const PluginLoadDecisionTypeId: unique symbol = Symbol.for('@systemfsoftware/stryker-js/PluginLoadDecision')
...
const uniqueSpecifiers = (specifiers: readonly string[]): readonly string[] => Array.dedupe(specifiers)
