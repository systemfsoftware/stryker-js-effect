...
import type { MutantResult, MutationTestResult } from '@systemfsoftware/stryker-js-plugin-interface'
import {
  DryRunCompleted,
  MutantTested,
...
import { makeBuiltinReporterFactories } from '@systemfsoftware/stryker-js/builtin-reporters'
