...
import { importModule } from '@systemfsoftware/stryker-js'
import { loadPlugins } from '@systemfsoftware/stryker-js/plugin-loader'
import type { LoadedPlugins } from '@systemfsoftware/stryker-js/plugin-loader'
