...
const HELP_RENDERED = RunEvent.HelpRendered.make({ schemaVersion: '1.0', code: 0, help: 'usage' })
const RUN_FAILED = RunEvent.RunFailed.make({ schemaVersion: '1.0', code: 3, error: 'x', remediation: 'y' })
