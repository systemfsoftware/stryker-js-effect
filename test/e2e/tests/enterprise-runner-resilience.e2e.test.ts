    ...
    await bdd.thenAssert(
      ...
      () => {
        ...
        const reportedMutants = events.filter(
          (event): event is Extract<RunEvent.RunEvent, { _tag: 'mutant' }> => event._tag === 'mutant',
        )
